...
describe Puppet::Type.type(:ibm_pkg) do
  ...
  describe :target do
    it 'should have a target parameter' do
      expect(Puppet::Type.type(:ibm_pkg).attrtype(:target)).to eq(:param)
    end
    describe 'invalid' do
  ...
  describe :package do
    it 'should have a package parameter' do
      expect(Puppet::Type.type(:ibm_pkg).attrtype(:package)).to eq(:param)
    end
    describe 'invalid' do
      let(:properties) do
        {
  ...
  describe :version do
    it 'should have a version parameter' do
      expect(Puppet::Type.type(:ibm_pkg).attrtype(:version)).to eq(:param)
    end
    describe 'invalid' do
      let(:properties) do
        {
